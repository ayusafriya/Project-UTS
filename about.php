...
<body>
					...
					<div class="col-sm-6">
						<div class="call_taital">
							<ul>
								...
								<li><a href="#">petshopfiyeay@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 col-lg-3">
					<div class="logo"><a href="index.php"><img src="images/logotoko.png"></a></div>
				</div>
				<div class="col-sm-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           <ul>
                                ...
                                <li>|</li>
                                <li><a class="nav-item nav-link" href="petcare.php">PetCare</a></li>
                                <li>|</li>
				...
				<div class="col-sm-6 col-lg-4">
					<div class="search_main">
						...
						<div class="right_main">
							<div class="login_text"><a href="admin/index.php">Login<span class="user_icon"><img src="images/user-icon.png"></span></a></div>
						</div>
				    </div>
				</div>
			</div>
	...
	<div class="about_section layout_padding">
		<div class="container">
			...
			<p class="lorem_text" style = "font-family:georgia"> <strong>Selamat datang di petshop kami, di mana kami berkomitmen untuk memberikan produk dan layanan terbaik untuk hewan peliharaan Anda.

Kami adalah sebuah petshop yang berdedikasi untuk membantu Anda merawat hewan peliharaan Anda dengan cara yang tepat dan bertanggung jawab.

Kami menawarkan berbagai macam produk berkualitas tinggi untuk hewan peliharaan Anda, termasuk makanan, perlengkapan, mainan, dan masih banyak lagi.

Staf kami terdiri dari orang-orang yang ahli dan berpengalaman dalam merawat hewan peliharaan, dan selalu siap membantu Anda dengan segala kebutuhan hewan peliharaan Anda.

Kami selalu berusaha memberikan layanan yang ramah dan profesional kepada pelanggan kami, dan kami berkomitmen untuk memastikan bahwa Anda dan hewan peliharaan Anda selalu merasa nyaman dan senang di petshop kami.</p>
